...
class Notification{
	...
	public:
		Notification();
		Notification(String& fid, String& mailbox, String& titulo, String& mensaje, unsigned long& actualTime);
    ...
    Notification::Notification(){
		...
		Notification::Notification(String& fid, String& mailbox, String& titulo, String& mensaje, unsigned long& actualTime){
			fid_ = fid;
			mailbox_ = mailbox;
			titulo_ = titulo;
			mensaje_ = mensaje;
      ...
      json[FID_COL_NAME] = fid_;
      json[MAILBOX_COL_NAME] = mailbox_;
      json[TITULO_COL_NAME] = titulo_;
      json[MENSAJE_COL_NAME] = mensaje_;
      json[TIME_COL_NAME] = time_;
