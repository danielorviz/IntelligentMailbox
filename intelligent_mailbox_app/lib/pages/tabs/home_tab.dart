...
class HomeTabState extends State<HomeTab> {
  ...
  Widget build(BuildContext context) {
    ...
    if (mailbox == null) {
      return const Center(
        child: Text('No mailbox selected'),
      );
    }

    final lastAuthorizedKey = mailbox.authorizedKeys.isNotEmpty
        ? mailbox.authorizedKeys.last
        : null;
    final lastPackage = mailbox.authorizedPackages.isNotEmpty
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if (lastAuthorizedKey != null) ...[
            ...
            Text('Fecha de inicio: ${DateTime.fromMillisecondsSinceEpoch(lastAuthorizedKey.initDate * 1000)}'),
            Text('Fecha de finalización: ${DateTime.fromMillisecondsSinceEpoch(lastAuthorizedKey.finishDate * 1000)}'),
            const SizedBox(height: 20),
          ],
          if (lastPackage != null) ...[
            const Text(
